...
#$PROGRAM $INPUT_FILE $ROW $COLUMN > assignmentExample.bfs.dot

#INPUT_FILE="./tests/mySimpleExample"
#ROW="1"
#COLUMN="2"
#echo -e "$BOLD_GREEN$PROGRAM $INPUT_FILE $ROW $COLUMN$NO_FORMAT"
#$PROGRAM $INPUT_FILE $ROW $COLUMN > mySimpleExample.bfs.dot

#INPUT_FILE="./tests/myOtherExample"
#ROW="3"
#COLUMN="7"
#echo -e "$BOLD_GREEN$PROGRAM $INPUT_FILE $ROW $COLUMN$NO_FORMAT"
#$PROGRAM $INPUT_FILE $ROW $COLUMN > myOtherExample.bfs.dot